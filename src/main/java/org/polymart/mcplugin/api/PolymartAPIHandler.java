...
public class PolymartAPIHandler {
  ...
  public static void post(
      String action, Map<String, Object> parameters, Consumer<JSONWrapper> response) {
              ...
              () -> {
                try {
                  HttpURLConnection http =
                      (HttpURLConnection) new URL("https://checkip.amazonaws.com").openConnection();
  ...
  private static void doMakeCall(
      String action,
      Map<String, Object> parameters,
      Consumer<JSONWrapper> response,
      String method,
        ...
        .runTaskAsynchronously(
            ...
            () -> {
              ...
              try {
                ...
                String signature =
                    encodeBase64(sha256_HMAC.doFinal(nonced.getBytes(StandardCharsets.UTF_8)));
                ...
                http.setRequestProperty(
                    "X-Polymart-Version", Main.that.getDescription().getVersion());
              ...
              Main.that
                  .getServer()
                  .getScheduler()
                  .runTask(Main.that, () -> response.accept(responseJSON));
            });
  }
  ...
  public static void runActions(JSONWrapper actions, CommandSender sender) {
    ...
    if (actions.get("sendMessage").asString() != null) {
      sendMessage(
          sender,
          ChatColor.translateAlternateColorCodes('&', actions.get("sendMessage").asString()));
    }
