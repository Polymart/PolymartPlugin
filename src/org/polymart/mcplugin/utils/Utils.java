...
public class Utils{
    ...
    public static String makeURLFriendlyString(String s){
        return s.toLowerCase().replaceAll("[^a-z0-9]", "-").replaceAll("-+", "-").replaceAll("^-*(.+?)-*$", "$1");
    }
    ...
    public static List<String> splitPreservingWordsAndColorCodes(String text, int length, final ChatColor def){
