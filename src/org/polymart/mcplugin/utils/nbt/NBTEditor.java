...
public final class NBTEditor {
    ...
    public static void setTag(Object tag, String key, Object value){
        try{
            setTag(tag, value, key);
        }
    ...
    public static Object getTag(Object tag, String key){
        try{
            return getTag(tag, (Object) key);
        }
        catch(Exception ex){ex.printStackTrace();}
        return null;
    }
